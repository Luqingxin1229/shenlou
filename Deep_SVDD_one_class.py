...
class DeepSVDD:
    def __init__(self, deep_model, input_shape=(3, 128, 45), objective='one_class',
...
from SVDD_models import VGGish

model = VGGish(inputshape=(3, 14, 45))
svdd = DeepSVDD(deep_model=model, representation_dim=32, objective='one-class')